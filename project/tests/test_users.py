...
class UserTests(unittest.TestCase):
    ...
    def test_change_email_address_page(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(b'Current Email: ricardo.lelis3@gmail.com', response.data)
    ...
    def test_change_email_address_with_existing_email(self):
        self.app.get('/register', follow_redirects=True)
        self.register('ricardo.lelis3@gmail.com', 'FlaskIsAwesome', 'FlaskIsAwesome')
        response = self.app.post('/email_change', data=dict(email='ricardo.lelis3@gmail.com'), follow_redirects=True)
        self.assertEqual(response.status_code, 200)
